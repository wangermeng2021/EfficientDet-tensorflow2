...
from model.efficientdet.object_detection import shape_utils
...
class TargetAssigner(object):
  ...
  def _create_regression_targets(self, anchors, groundtruth_boxes, match):
    ...
    # print(matched_anchors_mask.shape)
    # print(matched_reg_targets.shape)
    # print(unmatched_ignored_reg_targets.shape)
  ...
  def _default_regression_target(self):
    ...
    """
    "wangermeng_modified:20210220"
    # return tf.constant([self._box_coder.code_size * [0]], tf.float32)
    return tf.constant([self._box_coder.code_size*[-1]], tf.float32)
